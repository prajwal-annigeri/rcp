...
const (
	...
	ErrorType_NOT_SUPPORTED ErrorType = 6
)
...
type ReconfigureRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	VoterIds      []string               `protobuf:"bytes,1,rep,name=voterIds,proto3" json:"voterIds,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_rcppb_rcp_proto_rawDesc = "" +
	...
	"\x12ReconfigureRequest\x12\x1a\n" +
	"\bvoterIds\x18\x01 \x03(\tR\bvoterIds\"\x10\n" +
	"\x0eHealthzRequest*I\n" +
	"\aLogType\x12\t\n" +
	...
	"\rNOT_SUPPORTED\x10\x062\xfe\x03\n" +
	"\x03RCP\x12H\n" +
	...
	"\fCauseFailure\x12\x1a.rcppb.CauseFailureRequest\x1a\x15.rcppb.ClientResponse\"\x00\x12A\n" +
	"\vReconfigure\x12\x19.rcppb.ReconfigureRequest\x1a\x15.rcppb.ClientResponse\"\x00B\bZ\x06/rcppbb\x06proto3"
