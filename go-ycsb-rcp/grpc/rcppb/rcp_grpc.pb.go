...
type RCPClient interface {
	...
	Reconfigure(ctx context.Context, in *ReconfigureRequest, opts ...grpc.CallOption) (*ClientResponse, error)
}
...
func (c *rCPClient) Reconfigure(ctx context.Context, in *ReconfigureRequest, opts ...grpc.CallOption) (*ClientResponse, error) {
	out := new(ClientResponse)
	err := c.cc.Invoke(ctx, "/rcppb.RCP/Reconfigure", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RCPServer interface {
	...
	Reconfigure(context.Context, *ReconfigureRequest) (*ClientResponse, error)
...
func (UnimplementedRCPServer) Reconfigure(context.Context, *ReconfigureRequest) (*ClientResponse, error) {
...
func _RCP_Reconfigure_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReconfigureRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RCPServer).Reconfigure(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rcppb.RCP/Reconfigure",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RCPServer).Reconfigure(ctx, req.(*ReconfigureRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RCP_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RCP_Reconfigure_Handler,
		},
	},
