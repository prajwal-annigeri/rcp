...
2. Run the experiment using `./run.sh --protocol [PROTOCOL] --K [K] --bt [BATCH_TIMEOUT] --batch-low [BATCH_LOW] --batch-high [BATCH_HIGH] --client [CONCURRENT_CLIENT] --time [EXPERIMENT_TIME] --failure [None/LF/RF/LOF/ROF]`.
